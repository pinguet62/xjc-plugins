...
public class JavaParserUtils {
    ...
    /**
     * @param enumConstant The {@link BodyDeclaration} on which search.
     * @param annotation   The {@link AnnotationExpr#getName() annotation name} type to search.
    ...
    /**
     * @param type       The {@link TypeDeclaration} on which search.
     * @param name       The {@link VariableDeclarator#getName() field name} to search.
     * @param annotation The {@link AnnotationExpr#getName() annotation name} type to search.
     * @return The first found (doesn't support {@link Repeatable}).<br>
     * {@code null} if not found.
     */
    ...
    /**
     * @param annotation The {@link AnnotationExpr} on which search.
     * @param key        The {@link MemberValuePair#getName() annotation parameter name} to search.
    ...
    /**
     * @param type  The {@link EnumDeclaration} on which search.
     * @param entry The {@link EnumConstantDeclaration#getName() constant name} to search.
    ...
    /**
     * @param type The {@link TypeDeclaration} on which search.
     * @param name The {@link MethodDeclaration#getName() method name} to search.
     ...
     *
     * @param comment The initial text.
