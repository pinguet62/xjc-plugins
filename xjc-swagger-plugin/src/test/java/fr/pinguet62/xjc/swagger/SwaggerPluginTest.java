...
public class SwaggerPluginTest {
    ...
    private List<String> readType(String type) {
        String path = OUTPUT + "/fr/pinguet62/xjc/swagger/" + type + ".java";
    ...
    public void test_complexElement() {
        ...
        assertEquals("fr.pinguet62.xjc.swagger.CommentClass", parseApiModelProperty("AllTypesClass", "complexAttr").dataType);
        assertEquals("fr.pinguet62.xjc.swagger.EnumCommentClass", parseApiModelProperty("AllTypesClass", "enumAttr").dataType);
    }
